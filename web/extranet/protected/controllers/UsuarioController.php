...
class UsuarioController extends GxController {
    ...
    public function getRepresentingFields(){
		return Usuario::representingColumn();
	}
		...
		if (isset($_POST['Usuario'])) {
			...
			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					...
					$this->redirect($this->createUrlRel('view',array('id' => $model->idusuario,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Usuario'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idusuario,'success'=>'update')));
			}
		}
