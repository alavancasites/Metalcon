...
class PerfilAcessoController extends GxController {

	
    public function getRepresentingFields(){
		return PerfilAcesso::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'PerfilAcesso'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['PerfilAcesso'])) {
			$model->setAttributes($_POST['PerfilAcesso']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idperfil_acesso,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['PerfilAcesso'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idperfil_acesso,'success'=>'update')));
			}
		}
	...
	{
		$model=PerfilAcesso::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idperfil_acesso desc';
        }
		...
		$dataProvider = new CActiveDataProvider('PerfilAcesso', array(
            'criteria'=>$criteria,
			'pagination' => array(
